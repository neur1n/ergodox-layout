...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(KC_GRAVE,KC_1,KC_2,KC_3,KC_4,KC_5,LGUI(KC_SPACE),KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,KC_MEH,KC_LCTRL,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,LCA_T(KC_NO),KC_LALT,KC_LGUI,KC_HOME,KC_END,KC_ESCAPE,TG(1),TT(2),LCTL(KC_V),KC_SPACE,KC_DELETE,LCTL(KC_C),KC_MS_BTN3,KC_6,KC_7,KC_8,KC_9,KC_0,KC_BSLASH,KC_LBRACKET,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_MINUS,KC_H,KC_J,KC_K,KC_L,KC_SCOLON,KC_EQUAL,KC_RBRACKET,KC_N,KC_M,KC_COMMA,KC_DOT,KC_SLASH,KC_QUOTE,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,KC_CAPSLOCK,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_PSCREEN,KC_INSERT,KC_BSPACE,KC_ENTER),

  [1] = LAYOUT_ergodox(KC_GRAVE,KC_1,KC_2,KC_3,KC_4,KC_5,LGUI(KC_SPACE),KC_TAB,KC_QUOTE,KC_COMMA,KC_DOT,KC_P,KC_Y,KC_MEH,KC_LCTRL,KC_A,KC_O,KC_E,KC_U,KC_I,KC_LSHIFT,KC_SCOLON,KC_Q,KC_J,KC_K,KC_X,LCA_T(KC_NO),KC_LALT,KC_LGUI,KC_HOME,KC_END,KC_ESCAPE,KC_TRANSPARENT,TT(2),LCTL(KC_V),KC_SPACE,KC_DELETE,LCTL(KC_C),KC_MS_BTN3,KC_6,KC_7,KC_8,KC_9,KC_0,KC_BSLASH,KC_LBRACKET,KC_F,KC_G,KC_C,KC_R,KC_L,KC_MINUS,KC_D,KC_H,KC_T,KC_N,KC_S,KC_EQUAL,KC_RBRACKET,KC_B,KC_M,KC_W,KC_V,KC_Z,KC_SLASH,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,KC_CAPSLOCK,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_PSCREEN,KC_INSERT,KC_BSPACE,KC_ENTER),
